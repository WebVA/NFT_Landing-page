...
const MetaLogoLeftSmall = styled.svg`
  display: none;
  margin-left: 7px;
  margin-right: 7px;
  margin-top: 3px;
  ...
  return (
    <HeaderContainer>
      ...
      <MetaLogoContainer onClick={homeButtonHandler}>
        <MetaLogoBorderContainer>
          <MetaLogoBorderHalf>
            ...
            <MetaLogoLeftSmall width="711" height="62" viewBox="0 0 711 62" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M1 31L31.5 0.5H679L710 31L679.5 61.5H31.5L1 31Z" stroke="white" strokeWidth="2px" strokeOpacity='0.5' strokeLinecap="round" strokeLinejoin="round" />
            </MetaLogoLeftSmall>
            {/* 
      ...
      <HeaderRightContainer>
        <HeaderRightLineUpper width={'100%'} height='auto' src="assets/images/header/rightline.png"></HeaderRightLineUpper>
        ...
        <HeaderRightLineDown width={'100%'} height='auto' src="assets/images/header/rightline.png"></HeaderRightLineDown>
      </HeaderRightContainer>
    </HeaderContainer>
